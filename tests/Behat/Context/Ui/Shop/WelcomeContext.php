...
namespace Tests\Webgriffe\SyliusMeilisearchPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Webgriffe\SyliusMeilisearchPlugin\Behat\Page\Shop\WelcomePageInterface;
